...
# Lab 03 
# Lab Section: 13?
# Sources, people worked with, help given to: Tanner Brown, 
#
...
print(states)  # prints entire list


#now print the first element in the list

print(states[0])  # prints index 0 (aka element 1) from list
...
print(f"{states[1].upper()} is south of {states[0].upper()}")  # make sure to use .upper() in your varaible of f string!!!!!!
...
print(sorted(states))   # prints sorted states (temporarily)

print(states)     # prints unsorted list
